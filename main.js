...
var special_elements = [null, null, "noise-level-div", "bayer-size-div"];	

algorithm_dropdown.addEventListener("change", function() {
    // TODO: re-think this if-else statement
    ...
    for (let i = 0; i < special_elements.length; i++) {
        ...
        let element = document.getElementById(special_elements[i]);
        if (i == index) {
